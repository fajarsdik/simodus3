...
if (empty($_SESSION['admin'])) {
    ...
    if ($_SESSION['admin'] == 1 || $_SESSION['admin'] == 2) {
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Meter Dummy Standby</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                                ...
                                <table class="table table-hover" id="monitoring">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            $query = mysqli_query($config, "SELECT * FROM tbl_metdum_stok WHERE unit LIKE '$unit%' && status='ready' ORDER BY unit, tgl_pakai ASC");
                                    ...
                                    <table class="table table-hover" id="monitoring">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                $query = mysqli_query($config, "SELECT * FROM tbl_metdum_stok WHERE unit LIKE '$unit%' && status='ready' ORDER BY tgl_pakai ASC");
                                                if (mysqli_num_rows($query) > 0) {
                                                    $no = 1;
                                                    while ($row = mysqli_fetch_array($query)) {
                                                        ?>
