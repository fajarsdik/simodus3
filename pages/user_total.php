                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-13 col-md-8">
                            ...
                            if ($_SESSION['admin'] == 1) {
                                echo '
                                      <a href="?page=tud&act=add" class="btn btn-primary">Tambah Data</a>
                                 ';
                            }
                            ?>
                        </div>
                        <form method="post" action="?page=utd">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <th width="5%%" style="text-align: center">NIP</th>
                                    <th width="5%" style="text-align: center">Unit</th>
                                    <th width="5%" style="text-align: center">Level Admin</th>
