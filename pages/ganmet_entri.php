...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['act'])) {
        ...
        <div id = "page-wrapper">
            <div class = "row">
                <div  class = "col-lg-12">
                    <h1 class = "page-header">Entri Ganti Meter Paska</h1>
                </div>
            </div>
            <!-- Akhir Judul -->
            ...
            if (isset($_REQUEST['submit'])) {
                ...
                echo '
                    <div class="alert alert-info alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true" href="?page=egm"><a href="?page=egm" class="alert-link">&times;</a></button>
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-md-13 col-md-8">
                                            <form method="post" action="?page=egm">
                            ...
                            <div class="table-responsive">
                                ...
                                <tr>
                                    <th width="5%" style="text-align: center">Idpel</th>
                                        ...
                                        <th width="5%%" style="text-align: center">Nomor Meter Lama</th>
                                        <th width="5%%" style="text-align: center">Tahun Meter Lama</th>
                                        <th width="5%%" style="text-align: center">Stand Bongkar</th>
                                        <th width="5%%" style="text-align: center">Nomor Meter Baru</th>
                                        <th width="5%%" style="text-align: center">Tahun Meter Baru</th>
                ...
                if (mysqli_num_rows($query) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        if ($_SESSION['admin'] == 1 || $_SESSION['admin'] == 10) {
                            ...
                            echo '<a class="btn btn-primary" href="?page=egm&act=eam&id_meter=' . $row['id_meter'] . '">
                ...
                if ($cdata > $limit) {
                    ...
                    if ($pg > 1) {
                        $prev = $pg - 1;
                        echo '<li><a href="?page=egm&pg=1"><i class="fa fa-angle-double-left"></i></a></li>
                                  <li><a href="?page=egm&pg=' . $prev . '"><i class="fa fa-angle-left"></i></a></li>';
                    } else {
                    ...
                    for ($i = 1; $i <= $cpg; $i++)
                        if ($i != $pg) {
                            echo '<li><a href="?page=egm&pg=' . $i . '"> ' . $i . ' </a></li>';
                        } else {
                            echo '<li><a href="?page=egm&pg=' . $i . '"> ' . $i . ' </a></li>';
                        }
                    ...
                    if ($pg < $cpg) {
                        $next = $pg + 1;
                        echo '<li><a href="?page=egm&pg=' . $next . '"><i class="fa fa-angle-right"></i></a></li>
                                  <li><a href="?page=egm&pg=' . $cpg . '"><i class="fa fa-angle-double-right"></i></a></li>';
                    } else {
